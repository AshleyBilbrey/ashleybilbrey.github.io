...
### Choosing a Lock
For most people, a u-lock is a good primarily lock. I use the yellow Kryptonite Fahgettaboudit, one of the strongest available u-locks on the market. Do not use a cable lock as your primarily lock, as it can be cut in no time with bolt cutters. It's true that with cordless saws, it can only take a minute to go through a u-lock, but the goal is to provide as much deterrence as possible.
...
A good [city bike](#the-ideal-bike) has some mechanism to carry your things. You can put things in in a front basket, but if you want to carry more you can utilize a back rack. Here you can see my bike carrying a bunch of ice cream and other materials for a cyber security club meeting I was hosting.
...
## Collisions
I've been fortunate to have a bike collision (don't call them [accidents](https://newrepublic.com/article/166004/invention-accidents-car-crash-deaths-jessie-singer-book-review)"), a [broader look](https://doi.org/10.1289/ehp.0901747)!). However, in the United States, the poor bike infrastructure makes them more likely. Knowing what to do in a collision with a car is [important]. The main thing is to make sure to have documentation. A police report may be warranted. Make sure to get contact info of witnesses. Take as many photos, from different angles and perspectives. Visit an urgent care and make sure you're okay. Also make sure to replace your [helmet](#helmets), as they are only effective for one crash.
